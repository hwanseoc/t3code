...
describe("hasConfiguredT3CodeMcpServer", () => {
  ...
  it.effect("honors t3-code MCP entries supplied through launch args after merge", () =>
    Effect.gen(function* () {
      ...
      const previewFromLaunchArgs = yield* buildTurnStartParams({
        threadId: "provider-thread-1",
        runtimeMode: "full-access",
        prompt: "Browse",
        model: "gpt-5.3-codex",
      ...
      const unrelatedFromLaunchArgs = yield* buildTurnStartParams({
        threadId: "provider-thread-1",
        runtimeMode: "full-access",
        prompt: "Browse",
        model: "gpt-5.3-codex",
